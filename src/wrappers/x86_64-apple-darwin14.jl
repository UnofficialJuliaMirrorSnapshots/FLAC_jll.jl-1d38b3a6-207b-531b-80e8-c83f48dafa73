# Autogenerated wrapper script for FLAC_jll for x86_64-apple-darwin14
...
const libflac_splitpath = ["lib", "libFLAC.8.dylib"]
...
const libflac = "@rpath/libFLAC.8.dylib"
...
const libflacpp_splitpath = ["lib", "libFLAC++.6.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libflacpp = "@rpath/libFLAC++.6.dylib"

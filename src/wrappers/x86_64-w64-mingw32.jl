# Autogenerated wrapper script for FLAC_jll for x86_64-w64-mingw32
...
const metaflac_splitpath = ["bin", "metaflac.exe"]
...
const libflac_splitpath = ["bin", "libFLAC-8.dll"]
...
const libflac = "libFLAC-8.dll"


# Relative path to `flac`
const flac_splitpath = ["bin", "flac.exe"]
...
const libflacpp_splitpath = ["bin", "libFLAC++-6.dll"]
